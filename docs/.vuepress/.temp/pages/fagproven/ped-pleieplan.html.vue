<template><h2 id="pedagogisk-pleieplan" tabindex="-1"><a class="header-anchor" href="#pedagogisk-pleieplan" aria-hidden="true">#</a> Pedagogisk pleieplan</h2>
<h3 id="vannlatingstrang" tabindex="-1"><a class="header-anchor" href="#vannlatingstrang" aria-hidden="true">#</a> Vannlatingstrang</h3>
<table>
<thead>
<tr>
<th>PASIENT</th>
